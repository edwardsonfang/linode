...
#define HOST_NAME "your-bucket-name.sg-sin-1.linodeobjects.com"
...
int upload_file(const char *file_path) {
    ...
    snprintf(string_to_sign, sizeof(string_to_sign),
            ...
            datetime, date, "sg-sin-1", canonical_request_hash_hex);
    ...
    hmac_sha256((char *)k_date, "sg-sin-1", k_region, &len);
    ...
    snprintf(authorization_header, sizeof(authorization_header),
            ...
            "Authorization:AWS4-HMAC-SHA256 Credential=%s/%s/sg-sin-1/s3/aws4_request, SignedHeaders=host;x-amz-content-sha256;x-amz-date, Signature=%s",
